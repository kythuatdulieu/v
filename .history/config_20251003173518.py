...
EXPERIMENTS = {
    '7n_1n': {'N': 7, 'M': 1, 'description': '7 days input to predict 1 day'},
    '30n_1n': {'N': 30, 'M': 1, 'description': '30 days input to predict 1 day'},
    '30n_7n': {'N': 30, 'M': 7, 'description': '30 days input to predict 7 days'},
    '30n_30n': {'N': 30, 'M': 30, 'description': '30 days input to predict 30 days'},
    '90n_7n': {'N': 90, 'M': 7, 'description': '90 days input to predict 7 days'},
    '90n_30n': {'N': 90, 'M': 30, 'description': '90 days input to predict 30 days'}
}
